...
pub struct AddVestingRecipientAccounts<'a> {
...
impl<'a> TryFrom<&'a [AccountView]> for AddVestingRecipientAccounts<'a> {
...
impl<'a> InstructionAccounts<'a> for AddVestingRecipientAccounts<'a> {}
