...
impl<'a> TryFrom<&'a [AccountView]> for CloseDirectRecipientAccounts<'a> {
    ...
    fn try_from(accounts: &'a [AccountView]) -> Result<Self, Self::Error> {
        let [recipient, payer, distribution, recipient_account, event_authority, program] = accounts else {
        ...
        Ok(Self { recipient, payer, distribution, recipient_account, event_authority, program })
    }
}
