...
pub struct CreateVestingDistributionAccounts<'a> {
...
impl<'a> TryFrom<&'a [AccountView]> for CreateVestingDistributionAccounts<'a> {
...
impl<'a> InstructionAccounts<'a> for CreateVestingDistributionAccounts<'a> {}
