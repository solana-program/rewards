...
pub struct CloseVestingDistributionAccounts<'a> {
...
impl<'a> TryFrom<&'a [AccountView]> for CloseVestingDistributionAccounts<'a> {
    type Error = ProgramError;

    #[inline(always)]
    fn try_from(accounts: &'a [AccountView]) -> Result<Self, Self::Error> {
        let [authority, distribution, mint, vault, authority_token_account, token_program, event_authority, program] =
            accounts
        else {
...
impl<'a> InstructionAccounts<'a> for CloseVestingDistributionAccounts<'a> {}
